...
public class PutNet extends Command {
  ...
  /** Creates a new L4. */
  public PutNet(ArmSubsystem armSubsystem, ElevatorSubsystem elevatorSubsystem, BooleanSupplier ifFeedFunc) {
  ...
  public void initialize() {
    m_ArmSubsystem.putNet_Pivot();
    m_ElevatorSubsystem.putNet();
