...
public class PutProcessor extends Command {
  private ArmSubsystem m_ArmSubsystem;
  private ElevatorSubsystem m_ElevatorSubsystem;
  private BooleanSupplier ifFeedFunc;
  private boolean ifFeed;
  /** Creates a new L4. */
  public PutProcessor(ArmSubsystem armSubsystem, ElevatorSubsystem elevatorSubsystem, BooleanSupplier ifFeedFunc) {
  ...
  public void initialize() {
    m_ArmSubsystem.putProcesser_Pivot();
    m_ElevatorSubsystem.putProcesser();
