...
public class MAXSwerveModule {
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId,int absoluteEncoderId, boolean driveMotorReverse, boolean turningMotorReverse,boolean absoluteEncoderReversed ) {
  ...
  public void resetEncoders(){
    ...
    turningEncoder.setPosition(getAbsoluteEncoerRad());
  }
