...
public class RightReefVision extends SubsystemBase {
    ...
    public boolean states() {
     ...
     public void Target() {
        SmartDashboard.putBoolean("State Right", states());
    }
    ...
    public double Tid() {
        return LimelightHelpers.getFiducialID("limeligth");
    }
